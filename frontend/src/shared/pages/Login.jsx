...
export default function Login({ setIsAuth }) {
    ...
    const openDiscordLoginPopup = async () => {
        const popup = window.open('https://discord.com/oauth2/authorize?response_type=code&redirect_uri=http%3A%2F%2F192.168.129.72%3A5056&scope=identify%20guilds&client_id=1153335528494731387', 'Discord Login', 'width=800,height=600');
